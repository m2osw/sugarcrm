...
function checkDBSettings($silent = false)
{
    ...
    else
    {
        ...
        else
        {
            ...
            && empty($_SESSION['setup_db_drop_tables']))
            {
...
function printErrors($errors)
{
    ...
    else
    {
        ...
        // print out errors
        $validationErr  = "<div><p><b>{$mod_strings['ERR_DBCONF_VALIDATION']}</b></p>";
        $validationErr .= '<ul>';
...
function copyInputsIntoSession()
{
    ...
    && $_REQUEST['goto'] == 'SilentInstall')
    {
        ...
        {
            $_REQUEST['setup_db_sugarsales_user'] = 'same';
        }
    ...
    else
    {
        ...
        if(isset($_REQUEST['dbUSRData'])
        && !empty($_REQUEST['dbUSRData']))
        {
