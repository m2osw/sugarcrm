...
class ParserFactory
{
    ...
    public static function getParser($view, $moduleName, $packageName = null, $subpanelName = null)
    {
        ...
        || $packageName == 'studio')
        {
            ...
            //If we didn't find a specific parser, see if there is a view to type mapping
    ...
    protected static function checkForParserClass($view, $moduleName, $packageName, $nameOverride = false)
    {
        ...
        {
            $prefix = empty($packageName) ? 'build'
                                          : 'modify';
        }
        $class_name = strtolower($prefix . $view);
        $fileNames = array(
                "custom/modules/$moduleName/parsers/parser."   . $class_name . ".php",
                "modules/$moduleName/parsers/parser."          . $class_name . ".php",
                "custom/modules/ModuleBuilder/parsers/parser." . $class_name . ".php",
                "modules/ModuleBuilder/parsers/parser."        . $class_name . ".php",
                );
