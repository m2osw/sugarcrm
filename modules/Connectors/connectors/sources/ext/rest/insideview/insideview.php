...
class ext_rest_insideview extends ext_rest
{
    ...
    public function __construct()
    {
        ...
        ext_rest_insideview::$allowedModuleList = array(
    ...
    public function filterAllowedModules($moduleList)
    {
        ...
        {
            if(!in_array($module, ext_rest_insideview::$allowedModuleList))
            {
                continue;
            }
            else
    ...
    {
        $removeList = array();
        foreach(ext_rest_insideview::$allowedModuleList as $module_name => $display_name)
        {
