...
class SugarWidgetSubPanelTopButton extends SugarWidget
{
    ...
    function &_get_form($defines, $additionalFormFields = null, $asUrl = false)
    {
        ...
        if(isset($defines['focus']->name))
        {
            ...
            if(!empty($defines['child_module_name']))
            {
                ...
                $childFocusName = !empty($GLOBALS['beanList'][$defines['child_module_name']])
    ...
    function display(&$layout_def, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        if(!empty($this->acl)
        && ACLController::moduleSupportsACL($layout_def['module'])
        && !ACLController::checkAccess($layout_def['module'], $this->acl, true))
        {
            return $temp;
        }
        ...
        if(isset($_REQUEST['layout_def_key']) && $_REQUEST['layout_def_key'] == 'UserEAPM')
        {
            ...
            $megaLink = $this->_get_form($layout_def, $additionalFormFields,true);
