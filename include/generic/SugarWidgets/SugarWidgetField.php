...
class SugarWidgetField extends SugarWidget
{
    ...
    function displayHeaderCell($layout_def)
    {
        ...
        {
            $this->base_URL = $list_view->getBaseURL($html_var);
        ...
        $sort_by = $list_view->getSessionVariableName($html_var, "ORDER_BY").'='.$sort_by_name;
        ...
        $arrow_start = $list_view->getArrowUpDownStart($imgArrow);
        $arrow_end = $list_view->getArrowUpDownEnd($imgArrow);
