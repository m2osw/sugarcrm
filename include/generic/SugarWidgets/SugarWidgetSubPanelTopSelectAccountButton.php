...
class SugarWidgetSubPanelTopSelectAccountButton extends SugarWidgetSubPanelTopSelectButton
{
    function display(&$layout_def, $additionalFormFields = NULL, $nonbutton = false)
    {
        /*
         * i.dymovsky
         * Because when user role can't edit Accounts, it also can't
         * edit Membership Organizations. Select button leads to change
         * MO list
         *
         * See bug 25633
         * Bug25633 code change start
         */
        if(!ACLController::checkAccess($layout_def["module"], "edit", true))
        {
            return '';
        }
