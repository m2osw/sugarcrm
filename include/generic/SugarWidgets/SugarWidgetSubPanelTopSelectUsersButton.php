...
class SugarWidgetSubPanelTopSelectUsersButton extends SugarWidgetSubPanelTopSelectButton
{
    ...
    //layout_def is the collection of attributes associated with the button in the layout_defs file.
    function display(&$layout_def, $additionalFormFields = NULL, $nonbutton = false)
    {
        ...
        if(!empty($layout_def['filter_out_is_admin']))
        {
        ...
        if(isset($layout_def['field_to_name_array']) && is_array($layout_def['field_to_name_array']))
        {
