...
function ajaxLink($url)
{
    ...
    {
    // At this time the AJAX stuff is not working right because the
    // necessary JavaScript is not loaded correct so I removed that
    // functionality. It's about the speed anyway since in most
    // cases the entire page is loaded through this interface.
        return $url;
